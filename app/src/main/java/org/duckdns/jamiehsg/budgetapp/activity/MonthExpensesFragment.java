...
public class MonthExpensesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_month_expenses, container, false);
        amount=(EditText)rootView.findViewById(R.id.month_expense_amount_entry);
        desc=(EditText)rootView.findViewById(R.id.month_expense_desc_entry);
        category=(Spinner)rootView.findViewById(R.id.month_expense_spinner);
        Button submit=(Button)rootView.findViewById(R.id.submit_expense_month);
    ...
    public void submitExpense(View view){
        ...
        String urlS="http://www.jamieg.duckdns.org/budgetAPI/addMonthlyExpenses.php?username=jamie&pass=password&category="+cat+"&amount="+amountStr+"&desc="+descStr;
    ...
    public void handleResponse(String response){
        ...
        try{
            ...
            if(jsonObj.getString("success").equals("1")){
                TextView text=(TextView)rootView.findViewById(R.id.instructions_plan_expense_month);
