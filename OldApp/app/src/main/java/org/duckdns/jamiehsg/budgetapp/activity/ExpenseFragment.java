...
public class ExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        amount=(EditText)rootView.findViewById(R.id.expense_amount_entry);
        desc=(EditText)rootView.findViewById(R.id.expense_desc_entry);
        category=(Spinner)rootView.findViewById(R.id.expense_spinner);
        Button submit=(Button)rootView.findViewById(R.id.submit_expense);
